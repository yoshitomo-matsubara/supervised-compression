...
if __name__ == '__main__':
    ...
    parser.add_argument("--string-path", default='string.ptc', type=str, help="Output String")
    parser.add_argument("--param-path", required=True, type=str, help="Input Model Parameters")
